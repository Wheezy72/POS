<template>
    <header class="grid gap-2 lg:grid-cols-[12rem_minmax(0,1fr)_11rem]">
        <section class="rounded-2xl border border-slate-200 bg-white px-3 py-2 shadow-sm">
            ...
            <p class="mt-2 text-2xl font-black tracking-[0.08em] text-emerald-600">{{ clock }}</p>
        </section>
        ...
        <section class="rounded-2xl border border-slate-200 bg-white px-3 py-2 shadow-sm">
            ...
            <label class="mt-2 block text-[11px] font-bold uppercase tracking-[0.25em] text-slate-500">
                Barcode or SKU
            </label>
            <input
                ref="scannerInput"
                ...
                type="text"
                autocomplete="off"
                class="mt-1 h-12 w-full rounded-xl border border-slate-300 bg-slate-50 px-3 text-xl font-black tracking-wide text-slate-950 outline-none ring-0 placeholder:font-semibold placeholder:text-slate-400 focus:border-sky-500 focus:bg-white"
        ...
        <section class="rounded-2xl border border-slate-200 bg-white px-3 py-2 text-right shadow-sm">
