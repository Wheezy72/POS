<template>
    <aside class="grid gap-2">
        <button class="rounded-2xl border border-yellow-300 bg-yellow-300 px-3 py-2.5 text-left text-slate-950 shadow-sm hover:bg-yellow-200" @click="$emit('new-sale')">
            <p class="text-sm font-black">[F1] New</p>
        </button>
        <button class="rounded-2xl border border-sky-600 bg-sky-600 px-3 py-2.5 text-left text-white shadow-sm hover:bg-sky-500" @click="$emit('open-search')">
            <p class="text-sm font-black">[F2] Search</p>
        </button>
        <button class="rounded-2xl border border-emerald-600 bg-emerald-600 px-3 py-2.5 text-left text-white shadow-sm hover:bg-emerald-500" @click="$emit('open-pay')">
            <p class="text-sm font-black">[F4] Pay</p>
        </button>
        <button class="rounded-2xl border border-red-600 bg-red-600 px-3 py-2.5 text-left text-white shadow-sm hover:bg-red-500" @click="$emit('logout')">
            <p class="text-sm font-black">[F10] Logout</p>
        </button>
